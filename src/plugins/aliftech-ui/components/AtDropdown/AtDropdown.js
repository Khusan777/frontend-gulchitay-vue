              ...
              h(
                MenuItems,
                {
                  ...
                  class:
                    ...
                    props.position +
                    '-0 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black dark:ring-gray-700 ring-opacity-5 focus:outline-none',
                },
                {
                  default: () => [
                    h(
                      'div',
                      {
                        class: ['py-1', { 'divide-y divide-gray-100 dark:divide-gray-600': props.withDividers }],
                      },
                      [
