...
const SidebarItemLink = (props, { emit }) => {
  const buttonClasses = state =>
    state
      ? 'bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md dark:bg-indigo-500 dark:bg-opacity-10 dark:text-indigo-500'
              ...
              ? h(
                  'span',
                  {
                    class: [
                      ...
                      'dark:bg-indigo-500 dark:bg-opacity-10 dark:text-indigo-500 dark:group-hover:bg-indigo-600',
                    ],
                  },
                  item?.count
                )
