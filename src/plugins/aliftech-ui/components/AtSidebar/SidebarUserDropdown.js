            ...
            default: () => [
              h('div', [
                h(
                  ...
                  {
                    class: [
                      'group w-full bg-gray-100 rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700',
                      'hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-purple-500',
                      'dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-offset-gray-600 dark:focus:ring-purple-500',
                    ],
                  },
                  {
                    default: () =>
