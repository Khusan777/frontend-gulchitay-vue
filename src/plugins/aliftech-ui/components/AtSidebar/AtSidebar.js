    ...
    return h('div', { class: ['h-screen flex overflow-hidden z-50'] }, [
      ...
      h('div', { class: ['flex flex-col w-0 flex-1 overflow-hidden'] }, [
        this.isMobileOrTablet
                ...
                h(
                  'button',
                  {
                    class: [
                      ...
                      'text-gray-400 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500',
                      'dark:text-gray-300 dark:hover:text-white dark:focus:ring-indigo-500',
                    ],
          ...
          : null,
        h('div', { class: ['px-4 sm:px-6 py-6 overflow-auto h-screen dark:bg-gray-900 dark:text-white'] }, [
          this.$slots.default?.(),
        ]),
      ]),
    ]);
