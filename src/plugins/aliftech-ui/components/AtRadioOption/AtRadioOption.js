        ...
        h('input', {
          ...
          class: [
              ...
              : '',
            {
              ...
              'cursor-not-allowed': isDisabled,
              'border-red-300 text-red-500 focus:ring-red-500 dark:border-red-500 dark:text-red-500 dark:focus:ring-red-400':
                props.error,
              'border-green-500 text-green-500 focus:ring-green-500 dark:border-green-500 dark:text-green-500 dark:focus:ring-green-400':
                props.success,
            },
          ],
          name: props.name,
