            ...
            h(
              ListboxButton,
              {
                class: [
                  ...
                  {
                    ['cursor-default focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700']: !props.disabled,
                  },
                                  ...
                                  'li',
                                  {
                                    class: [
                                      item.value === (props.valueType ? selectedItem.value : selectedItem.value?.value)
                                        ? 'text-alpha bg-primary-600 dark:bg-primary-500 dark:text-alpha'
