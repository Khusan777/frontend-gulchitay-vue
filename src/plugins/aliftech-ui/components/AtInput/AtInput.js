            ...
            ? h(
                'button',
                {
                  ...
                  class: [
                    ...
                    {
                      ['bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-primary-400 dark:focus:border-primary-400']: !isDisabled,
