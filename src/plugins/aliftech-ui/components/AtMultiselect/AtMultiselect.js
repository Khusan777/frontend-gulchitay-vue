          ...
          'button',
          {
            ...
            class: [
              ...
              setInputBorderClass(this.error, this.success),
              {
                ...
                'bg-white focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:focus:ring-gray-500 dark:focus:border-gray-500': !isDisabled,
                              ...
                              'li',
                              {
                                class: [
                                  this.checkIfElementExistInSelectedOptions(option[this.valueType])
                                    ? 'text-alpha bg-primary-600 dark:bg-primary-500'
